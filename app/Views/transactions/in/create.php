...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow">
            <form action="/transactions/transaksi-masuk/save" method="post">
                <?= csrf_field(); ?>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <h6>Nota</h6>
                            <span style="font-size: 2rem;"><?= $no_transaksi; ?></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="layanan_id" id="layanan_id" class="custom-select <?= $validation->hasError('layanan_id') ? 'is-invalid' : '' ?>">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input class="form-control datepicker <?= $validation->hasError('tgl_masuk') ? 'is-invalid' : ''; ?>" type="text" name="tgl_masuk" id="tgl_masuk" value="<?= old('tgl_masuk'); ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input class="form-control datepicker <?= $validation->hasError('tgl_selesai') ? 'is-invalid' : ''; ?>" type="text" name="tgl_selesai" id="tgl_selesai" value="<?= old('tgl_selesai'); ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="lunas" id="lunas" class="custom-select">
                                <option value="0" <?= old('lunas') == 0 ? 'selected' : ''; ?>><?= strtoupper('non-lunas'); ?></option>
                                <option value="1" <?= old('lunas') == 1 ? 'selected' : ''; ?>><?= strtoupper('lunas'); ?></option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input class="form-control" type="number" name="total_harga" id="total_harga" placeholder="0" readonly>
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-lg text-right">
                            <a href="/transactions/transaksi-masuk" class="btn btn-secondary">Batal</a>
