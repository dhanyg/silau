...
<div class="row">
    <div class="col-lg-6">
        <div class="card shadow">
            <form action="/cash-flow/pengeluaran/update/<?= $pengeluaran['id']; ?>" method="post">
                <?= csrf_field(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control datepicker <?= $validation->hasError('tanggal') ? 'is-invalid' : ''; ?>" type="text" name="tanggal" id="tanggal" value="<?= old('tanggal', $pengeluaran['tanggal']) ?>">
                        <div class="invalid-feedback">
